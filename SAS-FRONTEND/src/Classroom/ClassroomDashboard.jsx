  ...
  <div className={styles.dashboardContainer}>
    ...
    {Object.keys(subject).map((key) => (
      <div key={key} className={styles.subjectCard}>
        ...
        <p className={styles.subjectName}>Subject Name: {subject[key].subName}</p>
        <div className={styles.buttonRow}>
          <button className={styles.actionButton} onClick={() => handleMarkAttendance(key)}>
            Mark Attendance
          </button>
          <button className={styles.actionButton} onClick={() => subjectDataPage(key)}>
            View Subject Data
          </button>
        </div>
      </div>
